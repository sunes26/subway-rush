...
def z2_floor_decals(a, coll):
    ...
    z = -5.994
    plan = [
        (10.0, 15.0, "SIGN_INFO", "1 · 3 출구  →"),
        (24.0, 15.0, "SIGN_INFO", "1 · 3 출구  →"),
        (38.0, 15.0, "SH_GREEN", "승강장  Platform  →"),
        (50.0, 15.0, "SH_GREEN", "승강장  Platform  →"),
        (17.0, 24.0, "SIGN_INFO", "화장실  Restroom  →"),
    ]
...
def z4_wall_ads(a):
    ...
    Z4 통로는 y 2.00 ~ 9.60 이다 (남벽 내면 2.00 · 북벽 내면 9.60).
    """
    # (내면 y, 실내를 향하는 방향)
    faces = ((9.60, -1), (2.00, 1))
