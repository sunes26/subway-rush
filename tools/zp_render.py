"""ZP 프리뷰 렌더. 기존 규격(340x460/뷰, 4면도 = 1360x460, 다크 배경, EEVEE/AgX)을 따른다.

blender -b zp_character.blend --python zp_render.py -- <outdir> <mode>
...
FLAT = os.environ.get("ZP_FLAT", "0") == "1"     # 무채색 실루엣 검증용
...
piv = bpy.data.objects.new("ZP_Pivot", None)
