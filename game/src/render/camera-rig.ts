...
const PRESETS: Record<ZoneId, CamPreset> = {
  ...
  Z1: { yaw: -14 * D, pitch: -46 * D, dist: 16, fov: 40 },
  Z2: { yaw: -16 * D, pitch: -38 * D, dist: 16, fov: 40 },
  Z3: { yaw: -4 * D, pitch: -34 * D, dist: 24, fov: 54 },   // dist는 아래에서 재계산
  Z4: { yaw: -22 * D, pitch: -32 * D, dist: 16, fov: 42 },
